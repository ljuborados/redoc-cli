            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (options.watch && fs_1.existsSync(pathToSpec)) {
                        ...
                        handlePath_1 = function (_path) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var e_3;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                        ...
                        watcher
                            .on('change', function (path) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                            ...
                            .on('add', function (path) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    spec = _a.sent();
                    return [4 /*yield*/, getPageHTML(spec, pathToSpec, tslib_1.__assign(tslib_1.__assign({}, options), { ssr: true }))];
                case 2:
                    pageHTML = _a.sent();
...
function respondWithGzip(contents, request, response, headers) {
    ...
    if (acceptEncoding.match(/\bdeflate\b/)) {
        response.writeHead(200, tslib_1.__assign(tslib_1.__assign({}, headers), { 'content-encoding': 'deflate' }));
        compressedStream = zlib.createDeflate();
    }
    else if (acceptEncoding.match(/\bgzip\b/)) {
        response.writeHead(200, tslib_1.__assign(tslib_1.__assign({}, headers), { 'content-encoding': 'gzip' }));
